...
class _SalaryAnalyticsScreenState extends State<SalaryAnalyticsScreen> {
  ...
  Future<void> _loadChartData() async {
    ...
    try {
      // 分別抓今年和去年整年的數據
      final thisYearPayrolls =
          await salaryRepository.getYearlyPayrolls(_selectedYear);
      final lastYearPayrolls = await salaryRepository
          .getYearlyPayrolls(_selectedYear - 1);
