...
import 'package:ttmastiff/features/coach/data/repositories/coach_repository.dart';
...
import '../../../course/presentation/widgets/status/course_category_badge.dart';
import 'dart:async';
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final double contentWidth =
                  _timeColumnWidth + (_tables.length * tableColumnWidth);
                              ...
                              child: Scrollbar(
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: SizedBox(
                                      width:
                                          contentWidth, // 當所有桌子都能放得下時，等於 constraints.maxWidth，完全填滿
                                      height: totalHeight,
                                      child: Stack(
                                        children: [
                                          // 背景格線
  ...
  List<Widget> _buildSessionCards(double tableColumnWidth) {
    ...
    for (final session in _sessions) {
      ...
      for (final table in session.tables) {
        ...
        final double width = (tableColumnWidth - 4).clamp(0.0, double.infinity);
